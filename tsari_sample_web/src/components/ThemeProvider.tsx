...
import { ThemeProvider, StyledEngineProvider, createTheme, PaletteOptions } from "@mui/material/styles";
...
export default function MyThemeProvider({ isDarkMode, children }: Props) {
